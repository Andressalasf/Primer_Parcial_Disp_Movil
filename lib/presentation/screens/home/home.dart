              ...
              child: Padding(
                ...
                child: Column( 
                  children: [SizedBox(height: 10,),
                    Text("Andres Felipe Salas - 192164", style: TextStyle(fontSize: 20, color: Colors.white)),
                    SizedBox(height: 10,),
                    Text("Brian Matheo Alvarez -192219", style: TextStyle(fontSize: 20, color: Colors.white)),
                    SizedBox(height: 10,),
                    Text("Programacion de dispositivos moviles", style: TextStyle(fontSize: 20, color: Colors.white)),
                    SizedBox(height: 10,),
                  ],
                ),
              ),
